...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707131906
...
cp %{_builddir}/progressbar-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-progressbar/7b6fd4fb12f5faab38bf585461dd1a02da2e70f6 || :
